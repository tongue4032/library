...
<head>
    ...
    <link href="/common/css/custom-styles10.css" rel="stylesheet" />
                        ...
                        <div class="table-responsive">
                            <table width="900" border="1" cellpadding="0">
  								<tr style="background-color: #7dbfe699;">
    								<th width="110" scope="col" class="text-center">Admin ID</th>
    								<th width="150" scope="col" class="text-center">Admin Name</th>
    							...
    							<tr>
    								...
    								<td class="text-center"><a class="editBtn" data-id="<?php echo $admin['admin_id']; ?>" href="javascript: void (0);"><span class="fa fa-edit"></span></a></td>
    							</tr>
                                <?php } ?>
							</table>
                            <div>
