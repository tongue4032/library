...
<head>
    ...
    <link href="/common/css/custom-styles11.css" rel="stylesheet" />
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">Modify Admins Role</h1>
                    </div>
                </div>
                <div class="panel panel-default">
                    <form action="/Admin/change_admin_role" method="post" id="form1">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <div style="margin-left: 340px;margin-top: 30px;color: #fff;">
                                <button style="background-color: #3a7ed4;border-radius: 12px;padding: 10px 20px;">
                                    <a href="/Permissions/role_admins" style="color: #fff;text-decoration:none;">Return</a>
                                </button>
    ...
    <script>
            ...
            function encode(){
                var data = $("#form1").serialize();//传数据
                $.ajax( {
                    type : "POST",
                    url : "change_admin_role",
                    dataType:"json",
                    data : data,
                    success : function(data) {
                        if (data.code == 1) {
                            alert(data.message);
                            window.location='/Permissions/role_admins';
                        }else{
                            alert(data.message);
                        }
                    }
