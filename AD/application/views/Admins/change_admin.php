...
<head>
    ...
    <link href="/common/css/show6.css" rel="stylesheet" />
    <link href="/common/css/font-awesome.css" rel="stylesheet" />
    <link href="/common/css/custom-styles6.css" rel="stylesheet" />
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">Modify Admins</h1>
                    </div>
                </div>
                <div class="panel panel-default">
                    <form action="/Admin/change_admins" method="post" id="form" novalidate>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <div class="table-responsive">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;Admin Name：
                                    <input id="admin_name" name="admin_name"  type="text" value="<?php echo $admin['admin_name'] ?>" required>
                                </p>
                            </div>  
                            <div style="margin-left: 340px;margin-top: 30px;color: #fff;">
                                <button style="background-color: #3a7ed4;border-radius: 12px;padding: 10px 20px;">
                                    <a href="/Admin/show_admins" style="color: #fff;text-decoration:none;">Return</a>
                                </button>
